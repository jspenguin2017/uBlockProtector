 ...
 * Solutions from Anti-Adblock Killer (originally by Reek) are modified to fit my core library API.
...

{
    ...
    const genericWhitelist1 = [
        ...
        //False positives
        "techradar.com", "imdb.com", "babbel.com", "buxfer.com", "store.playstation.com",
    ];
...
if (a.domCmp(["vidoza.net", "videowood.tv", "l2s.io", "adshort.co", "linksh.top", "adshorte.com",
    ...
    "urle.co", "oload.info", "shink.me", "doramasflv.net", "backin.net", "adshort.im", "ddlfr.pw"])) {
    a.filter("open");
}
