...
if (a.domCmp(["usapoliticstoday.com", "vidlox.tv", "exrapidleech.info", "urle.co", "gsmarena.com",
    "darmowe-pornosy.pl", "salon.com", "linx.cloud"])) {
    a.filter("eval");
}
...
if (a.domCmp(["apkmirror.com", "freepdf-books.com", "bc.vc", "themeslide.com", "linkdrop.net",
    ...
    "coshurl.co", "leechall.com", "gratisjuegos.co", "zonadescarga.info"])) {
...
if (a.domCmp(["socketloop.com"])) {
    ...
    a.filter("setTimeout", a.matchMethod.RegExp, /document\.getElementById\('\w+'\)\.innerHTML='\s*';/);
}
