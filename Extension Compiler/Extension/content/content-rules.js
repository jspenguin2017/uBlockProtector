...
if (a.domCmp(["money.pl", "parenting.pl", "tech.wp.pl", "sportowefakty.wp.pl", "teleshow.wp.pl", "moto.wp.pl",
    "portal.abczdrowie.pl", "film.wp.pl"], true)) {
    //Thanks to szymon1118
...
if (a.domCmp(["cutwin.com", "cut-urls.com", "adbull.me", "xess.pro"])) {
    a.bait("div", "#test-block", true);
    a.timewarp("setInterval", a.matchMethod.stringExact, "1000");
}
...
<VAST version="2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="vast.xsd">
  <Ad id="SKIPAD">
    <InLine>
      <AdSystem version="v1">aiMatch</AdSystem>
      <AdTitle><![CDATA[SKIPAD]]></AdTitle>
      <Error>
        <![CDATA[https://jspenguin.com/API/uBlockProtector/Solutions/Blocked.php]]>
      </Error>
      <Impression id="itv">
        <![CDATA[https://jspenguin.com/API/uBlockProtector/Solutions/Blocked.php]]>
      </Impression>
      ...
      <Impression id="itvStart">
        <![CDATA[https://jspenguin.com/API/uBlockProtector/Solutions/Blocked.php]]>
      </Impression>
      <Impression id="itvMid">
        <![CDATA[https://jspenguin.com/API/uBlockProtector/Solutions/Blocked.php]]>
      </Impression>
      <Impression id="itvComplete1">
        <![CDATA[https://jspenguin.com/API/uBlockProtector/Solutions/Blocked.php]]>
      </Impression>
      <Impression id="itvComplete2">
        <![CDATA[https://jspenguin.com/API/uBlockProtector/Solutions/Blocked.php]]>
      </Impression>
      <Creatives>
        <Creative id="video" sequence="0" AdID="">
          <Linear>
            ...
            <MediaFiles>
              <MediaFile id="MP4_H.264_MAIN" delivery="progressive" bitrate="600" width="480" height="272" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="MP4_H.264_MAIN" delivery="progressive" bitrate="800" width="640" height="360" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="CDN1_MP4_H.264_MAIN" delivery="progressive" bitrate="1200" width="704" height="396" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="CDN1_MP4_H.264_MAIN" delivery="progressive" bitrate="1500" width="704" height="396" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="CDN1_MP4_H.264_MAIN" delivery="progressive" bitrate="1800" width="704" height="396" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="TS_H.264_MAIN" delivery="progressive" bitrate="1250" width="544" height="576" type="video/ts">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="TS_H264_HP_41" delivery="progressive" bitrate="6500" width="720" height="576" type="video/mp2ts">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="TS_MPG_MP_HL" delivery="progressive" bitrate="6500" width="720" height="576" type="video/mp2ts">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="TS_H264_HP_41" delivery="progressive" bitrate="15000" width="1920" height="1080" type="video/mp2ts">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="TS_MPG_MP_HL" delivery="progressive" bitrate="15000" width="1920" height="1080" type="video/mp2ts">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="MP4_H.264_BASELINE" delivery="progressive" bitrate="300" width="512" height="288" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="MP4_H.264_BASELINE" delivery="progressive" bitrate="600" width="512" height="288" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="MP4_H.264_BASELINE" delivery="progressive" bitrate="1200" width="704" height="396" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="3GP_H.264_BASELINE" delivery="progressive" bitrate="128" width="176" height="144" type="video/3gpp">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="3GP_H.264_BASELINE" delivery="progressive" bitrate="300" width="320" height="240" type="video/3gpp">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
              <MediaFile id="android" delivery="progressive" bitrate="600" width="480" height="272" type="video/mp4">
                <![CDATA[https://toots.itv.com/ads/fail.mp4]]>
              </MediaFile>
            </MediaFiles>
          </Linear>
