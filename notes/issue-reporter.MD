...
not take back your contributions at a later time.

### Data Storage

The server acting as temporary storage has a few systems in place to prevent
unauthorized access:
...
Moderated reports are stored in a GitHub issues tracker.
