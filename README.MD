...
This project was completely redesigned on version 4.0, which is also when the license changed to GNU GPL v3. Everything else, unless otherwise specified, falls under this license. 
